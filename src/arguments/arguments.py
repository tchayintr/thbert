...
class ArgumentLoader(object):
    ...
    def get_full_parser(self):
        ...
        parser.add_argument('--input_data_format', type=str.lower, default='txt', help='Choose format of input data from among \'txt\' and \'json\' (Default: txt)')
        parser.add_argument('--dic_data_format', type=str.lower, default='txt', help='Choose format of input dictionary data (raw vocabularies) from among \'txt\' and \'json\' (Default: txt)')
