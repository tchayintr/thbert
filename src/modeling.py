...
class BertModel(object):
    ...
    def __init__(
        ...
        Args:
            ...
            use_one_hot_embeddings: (optional) bool. Whether to use one-hot word embeddings or tf.
                embedding_lookup() for the word embeddings.
        ...
        # print(tf.compat.v1.variable_scope(scope, default_name='bert'))
        # print(tf.name_scope('bert'))
...
def get_assignment_map_from_checkpoint(tvars, init_checkpoint):
    ...
    for x in init_vars:
        ...
        # https://github.com/google-research/bert/issues/383#issuecomment-470054369
...
def generate_initial_value(shape, stddev):
    '''Generate an `initial value` using truncated normal distribution
        with the give shape and standard deviation
    '''
...
def embedding_lookup(input_ids,
    ...
    Args:
        ...
        use_one_hot_embeddings: bool. If True, use one-hot method for word embeddings.
    ...
    embedding_table = tf.Variable(
        ...
        initial_value=generate_initial_value(
    ...
    Args:
        ...
        do_return_2d_tensor: bool. If True, the output will be of shape [batch_size
            * from_seq_length, num_attention_heads * size_per_head]. If False, the
            output will be of shape [batch_size, from_seq_length, num_attention_heads * size_per_head].
...
def transformer_model(input_tensor,
    ...
    Args:
        ...
        attention_mask: (optional) int32 Tensor of shape [batch_size, seq_length,
            seq_length], with 1 for positions that can be attended to and 0 in positions that should not be.
    ...
    if input_width != hidden_size:
        raise ValueError('The width of the input tensor ({}) != hidden size ({})'.format(
...
def get_shape_list(tensor, expected_rank=None, name=None):
    ...
    Returns:
        ...
        be returned as python integers, and dynamic dimensions will be returned as tf.Tensor scalars.
    '''
    if name is None:
        name = tensor.name
...
def reshape_to_matrix(input_tensor):
    ...
    if ndims < 2:
        raise ValueError('Input tensor must have at least rank 2. Shape = {}'.format((input_tensor.shape)))
    if ndims == 2:
        return input_tensor
